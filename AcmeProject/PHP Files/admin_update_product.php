...
<body>
    <div class="d-flex vh-100 justify-content-center align-items-center h-100vh">
        <form enctype="multipart/form-data" method="POST" action="admin_update_pdt.php" class="w-25 text-center bg-secondary p-4">
        
        <h2 class="text-white">Upload Products</h2>

            <input  name="pdt_id"  class='d-none' value="<?php echo $_GET['pdt_id'] ?>">
